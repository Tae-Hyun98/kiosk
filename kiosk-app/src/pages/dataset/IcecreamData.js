const icecream = [{
    id: 'ice01',
    image: process.env.PUBLIC_URL + '/assets/images/ice/ice01.png',
    title: '디노 젤리',
    tag: '#배라이즈백 #공룡젤리',
    desc: '파인애플 & 그린 애플 아이스크림에 달록달록 공룡젤리가 콩콩!',
    price: 3500
  },

  {
    id: 'ice02',
    image: process.env.PUBLIC_URL + '/assets/images/ice/ice02.png',
    title: '시카고 팝콘',
    tag: '#팝콘맛아이스크림 #이달의맛',
    desc: '카마멜과 치즈맛이 조화를 이루는 시카고 스타일 팝콘을 아이스크림으로 만나보세요!',
    price: 3500
  },
  ...
  {
    id: 'ice07',
    image: process.env.PUBLIC_URL + '/assets/images/ice/ice07.png',
    title: '오레오 쿠키 앤 크림',
    tag: '#오레오쿠키앤크림',
  ...
  {
    id: 'ice08',
    image: process.env.PUBLIC_URL + '/assets/images/ice/ice08.png',
    title: '월넛',
    tag: '#월넛',
